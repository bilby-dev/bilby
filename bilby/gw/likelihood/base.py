...
class GravitationalWaveTransient(Likelihood):
    ...
    def calculate_snrs(self, waveform_polarizations, interferometer, *, return_array=True, parameters):
        ...
        d_inner_h = (xp.conj(interferometer.whitened_frequency_domain_strain) * whitened_signal).sum()
        ...
        if return_array is False:
            ...
            d_inner_h_integrand = xp.tile(
                xp.conj(interferometer.whitened_frequency_domain_strain) * whitened_signal,
            ...
            d_inner_h_integrand = (
                whitened_signal
                * xp.conj(interferometer.whitened_frequency_domain_strain)
            )
