...
# injection_parameters = dict(chirp_mass=25., mass_ratio=0.8, a_1=0.4, a_2=0.3, tilt_1=0.5, tilt_2=1.0, phi_12=1.7, phi_jl=0.3,
#                             luminosity_distance=4000., iota=0.4, psi=2.659, phase=1.3, geocent_time=1126259642.413,
#                             waveform_approximant='IMRPhenomPv2', reference_frequency=50., ra=1.375, dec=-1.2108)
...
waveform_generator = tupak.waveform_generator.WaveformGenerator(
    ...
    parameter_conversion=tupak.source.convert_to_lal_binary_black_hole_parameters,
    parameters=injection_parameters)
hf_signal = waveform_generator.frequency_domain_strain()

tupak.source.convert_from_lal_binary_black_hole_parameters(parameters=injection_parameters,
                                                           search_keys=['chirp_mass', 'mass_ratio'])
...
priors['chirp_mass'] = tupak.prior.create_default_prior('chirp_mass')
priors['mass_ratio'] = tupak.prior.create_default_prior('mass_ratio')
