...
# We can make uniform distributions.
priors["mass_1"] = bilby.core.prior.Uniform(name="mass_1", minimum=20, maximum=40, unit="$M_{\\odot}$")
priors["mass_2"] = bilby.core.prior.Uniform(name="mass_2", minimum=20, maximum=40, unit="$M_{\\odot}$")
...
p_a_2 = a_2**4
priors["a_2"] = bilby.core.prior.Interped(name="a_2", xx=a_2, yy=p_a_2, minimum=0, maximum=0.5)
