...
likelihood = bilby.core.likelihood.CeleriteLikelihood(kernel=kernel, mean_model=mean_model, t=times, y=ys, yerr=1e-6)
...
priors["kernel:terms[0]:log_S0"] = Uniform(minimum=-10, maximum=30, name="log_S0", latex_label=r"$\ln S_0$")
priors["kernel:terms[0]:log_Q"] = Uniform(minimum=-10, maximum=30, name="log_Q", latex_label=r"$\ln Q$")
priors["kernel:terms[0]:log_omega0"] = Uniform(minimum=-5, maximum=5, name="log_omega0", latex_label=r"$\ln \omega_0$")
priors["kernel:terms[1]:log_sigma"] = Uniform(minimum=-5, maximum=5, name="log sigma", latex_label=r"$\ln \sigma$")
...
samples = [result.posterior.iloc[random.rng.integers(len(result.posterior))] for _ in range(10)]
