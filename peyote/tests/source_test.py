...
class TestAstrophysicalSourceInstantiation(unittest.TestCase):
...
class TestCompactBinaryCoalescenceInstantiation(unittest.TestCase):
...
class TestBinaryBlackHoleInstantiation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        polarisation_angle = 15
        eccentricity = 16
        self.source = BinaryBlackHole(name, right_ascension, declination, luminosity_distance, mass_1, mass_2,
                                      spin_1, spin_2, coalescence_time, inclination_angle, waveform_phase,
                                      polarisation_angle, eccentricity)
...
class TestSupernovaInstantiation(unittest.TestCase):
    ...
    def setUp(self):
        name = "test_name"
        right_ascension, declination, luminosity_distance = 1, 2, 3
        self.source = Supernova(name, right_ascension, declination, luminosity_distance)
